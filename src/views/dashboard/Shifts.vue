    ...
    <v-main>
      <v-container>
        <v-row>
          <v-col>
            <v-card>
              <v-card-title>نوبت های من</v-card-title>
              <v-card-text>
                <p>به سامانه نوبت دهی آنلاین کلینیک ساعی خوش آمدید.</p>
                <p>برای ثبت نوبت جدید از منوی سمت راست به قسمت نوبت دهی رفته و بر روی گزینه ثبت نوبت جدید کلیک نمایید. سپس با انتخاب زمان و خدمات مورد نظر نوبت دلخواه خود را ثبت کنید.</p>
